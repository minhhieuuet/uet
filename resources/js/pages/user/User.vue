      ...
      <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
        <md-card>
          <md-card-header data-background-color="green">
            <h4 class="title">Quản lý hồ sơ</h4>
          </md-card-header>
          <md-card-content>
            <data-table :get-data="getData" ref="datatable">
                ...
                <th class="col_title_en">Họ tên</th>
                <th class="col_title_jp">Tài khoản</th>
                <th>Email</th>
                <th>Chức vụ</th>
                ...
                <template slot="body" slot-scope="{ item, index }">
                  <tr>
                    ...
                    <td class="text-center" v-html="item.role.name"></td>
                    <td v-html="item.organization.name"></td>
                    <td class="text-center">
  ...
  methods: {
    ...
    removeManyStudent() {
      ...
      getData (params) {
        ...
        return rf.getRequest('UserRequest').getUsers(meta);
      },
      refresh() {
        this.isLoading = true;
        this.$refs.datatable.refresh();
